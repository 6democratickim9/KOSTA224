...
public class MemberServiceImpl implements MemberService {
	...
	//@Autowired 는 스프링 컨테이너에 생성된 bean 중에 일치되는 타입의 bean을 주입
	//@Autowired
	//@Resource 어노테이션도 동일한 역할 
	//@Resource
	//@Autowired 와 @Resource는 타입을 이용해 일치되는 bean을 주입하는 방식으로 
	//하나의 인터페이스를 여러개의 클래스가 구현하는 경우에는 BeanCreationException과 NoUniqueBeanDefinitionException 이 발생된다 
