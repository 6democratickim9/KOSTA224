...
import org.kosta.model.member.DuplicatedIdException;
...
public class TestPerformanceCheck {
    ...
    개발단계 
    1. 로그 : Log4j  -> 단위테스트 2-SpringAOP2-ex2-log4j 
    ...
    3. 위의 1. 2 의 기능을 서비스 각 메서드에 직접 코딩을 하는 것이 아니라 
        ...
        2) AOP pointcut( 적용대상을 지정 ) -> bean(*Service)  : Service로 마치는 bean id가 대상 
