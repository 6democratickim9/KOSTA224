...
<script type="text/javascript">
	$(document).ready(function() {
		...
		//fried id tbody의 하위td가 클릭되었을 때 자신의 텍스트가 alert으로 출력
		//selector : #frined td
		$("#friend td").click(function(){
			alert($(this).text());
			//클릭된 td 요소의 상위 tr로 이동해서 그 tr이 가진 하위 요소 첫번째 td를 select 해서 text 출력
			let info=$(this).parent().children().eq(0).text();s
			alert(info);
		})
	});
</script>
